...
public struct DocumentID<Value: DocumentIDWrappable & Codable>:
  ...
  private func logIgnoredValueWarning(value: Value) {
    // TODO: Integrate with Swift logging framework
    print("""
      [FirebaseFirestore][Warning] Attempting to initialize or set a @DocumentID property with \
      a non-nil value: "\(value)". The document ID is managed by Firestore and any initialized \
      or set value will be ignored. The ID is automatically set when reading from Firestore.
      """)
  }
}
